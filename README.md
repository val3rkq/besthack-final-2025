...
Проект включает в себя современный веб-интерфейс для тестирования API. Доступен по адресу http://localhost:8000/ после запуска сервера.

Интерфейс предоставляет три вкладки:
- Поиск адреса - поиск адресов по текстовому запросу
- Обратное геокодирование - поиск адресов по координатам
- Сравнение адресов - сравнение двух адресов
